...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-176824842-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-176824842-1');
  </script>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <div class="icon-box">
                      ...
                      <p style="color:black">Hora de pensar à frente</p>
                  </div>
                  <div class="portfolio-info">
                    <div class="portfolio-links">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-1">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            Acesse o <a href="https://forms.gle/stG3nj8XSwCcTo3P7" target="_blank">questionário</a> para avaliar o framework <b>Olhar Para o Sistema</b>.
